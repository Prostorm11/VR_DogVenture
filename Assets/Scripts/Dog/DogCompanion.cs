...
namespace VRProject.Dog
{
    ...
    public class DogCompanion : MonoBehaviour
    {
        ...
        public void DismissBees()
        {
            ...
            if (VRProject.Punishment.PunishmentSystem.Instance != null)
            {
                VRProject.Punishment.PunishmentSystem.Instance.StopPunishment();
            }
        ...
        /// <summary>
        /// Bark to dismiss bees (alias for DismissBees).
        /// </summary>
        ...
        /// <summary>
        /// Teleport the dog to near the player.
        /// </summary>
        public void TeleportToPlayer()
        {
            ...
            if (target != null)
            {
                Vector3 newPos = target.position + target.forward * forwardOffset + target.right * sideOffset;
                newPos.y = 0f; // Keep on ground
                transform.position = newPos;
                Debug.Log($"[DogCompanion] Teleported to {newPos}");
            }
        }
