...
namespace VRProject.Game
{
    ...
    public class SimpleWordGame : MonoBehaviour
    {
        ...
        private GameObject CreateLetterCube(char letter, Vector3 position)
        {
            ...
            if (VRProject.WordPuzzle.LetterTextureGenerator.Instance != null)
            {
                Material genMat = VRProject.WordPuzzle.LetterTextureGenerator.Instance.GetMaterialForLetter(letter);
                if (genMat != null)
                {
